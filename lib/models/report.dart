...
class Report {
  ...
  Report copyWith({
    ...
    AdminDepartment? assignedDepartment,
    String? assignedTo,
    ...
    return Report(
      ...
      evidencePackage: evidencePackage ?? this.evidencePackage,
      ...
      isCommunityVerified: isCommunityVerified ?? this.isCommunityVerified,
      ...
      progressRequestedAt: progressRequestedAt ?? this.progressRequestedAt,
    );
  }
