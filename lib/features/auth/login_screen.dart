...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final email =
          raw.toLowerCase() == kDemoAdminUsername ? kDemoAdminEmail : raw;
              ...
              child: Column(
                ...
                children: [
                  const Icon(Icons.location_city,
                      size: 56, color: NivaraColors.primary),
                  ...
                  TextFormField(
                    ...
                    autofillHints:
                        _adminMode ? null : const [AutofillHints.email],
                    textInputAction: TextInputAction.next,
                    decoration: InputDecoration(
                      labelText: _adminMode ? 'Username' : 'Email',
                      prefixIcon: Icon(_adminMode
                  ...
                  TextFormField(
                    ...
                    autofillHints:
                        _adminMode ? null : const [AutofillHints.password],
